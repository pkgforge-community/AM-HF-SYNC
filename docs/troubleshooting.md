...
Starting with version [9.9.5](https://github.com/pkgforge-community/AM-HF-SYNC/releases/tag/9.9.5), a checksum validation method was introduced for installed apps. Its status is shown as verified when installing or updating apps. When listing all installed apps, these apps will have a ✔ beside its version number.
