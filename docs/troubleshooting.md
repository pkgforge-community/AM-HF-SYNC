...
Starting with version [9.9.5](https://github.com/pkgforge-community/AM-HF-SYNC/releases/tag/9.9.5), a checksum has been introduced for installed apps. Its status is verified when installing or updating apps.
